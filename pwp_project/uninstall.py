...
def before_uninstall():
    ...
    This function performs cleanup operations before removing the PWP Project System.
    """
    # Check if there are any active documents
    if has_active_documents():
        frappe.throw("Cannot uninstall PWP Project System. There are active documents in the system.")

    # Check if there are any pending workflows
    if has_pending_workflows():
        frappe.throw("Cannot uninstall PWP Project System. There are pending workflows in the system.")

def after_uninstall():
    """
    Function to be executed after the app is uninstalled.
    This function performs final cleanup operations after removing the PWP Project System.
    """
    # Clean up any remaining data
    cleanup_remaining_data()

    frappe.msgprint("PWP Project System has been uninstalled successfully!")
