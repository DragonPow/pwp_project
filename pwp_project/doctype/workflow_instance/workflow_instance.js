...
function load_pending_actions(frm) {
    frappe.call({
        method: 'pwp_project.pwp_project.doctype.workflow_instance.workflow_instance.get_workflow_instance_details',
        args: {
...
function execute_workflow_action(frm, action_name, action_type) {
    ...
    const dialog = new frappe.ui.Dialog({
        ...
        primary_action: function() {
            ...
            frappe.call({
                method: 'pwp_project.pwp_project.doctype.workflow_instance.workflow_instance.execute_workflow_action',
                args: {
...
function reassign_step(frm) {
    const dialog = new frappe.ui.Dialog({
        ...
        primary_action: function() {
            ...
            frappe.call({
                method: 'pwp_project.pwp_project.doctype.workflow_instance.workflow_instance.reassign_workflow_step',
                args: {
                    workflow_instance: frm.doc.name,
...
function cancel_workflow(frm) {
    const dialog = new frappe.ui.Dialog({
        ...
        primary_action: function() {
            ...
            frappe.call({
                method: 'pwp_project.pwp_project.doctype.workflow_instance.workflow_instance.cancel_workflow_instance',
                args: {
                    workflow_instance: frm.doc.name,
                    reason: reason
                },
...
function show_workflow_history(frm) {
    frappe.call({
        method: 'pwp_project.pwp_project.doctype.workflow_instance.workflow_instance.get_workflow_history',
        args: {
            workflow_instance: frm.doc.name
        },
        callback: function(r) {
