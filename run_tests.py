...
def run_all_tests():
    """Run all tests for the Electronic Office application"""
    
    # Import test modules
    from electronic_office.electronic_office.doctype.digital_signature.test_digital_signature import TestDigitalSignature
    from electronic_office.electronic_office.doctype.user_crypto_keys.test_user_crypto_keys import TestUserCryptoKeys
    from electronic_office.electronic_office.doctype.workflow_definition.test_workflow_definition import TestWorkflowDefinition
    from electronic_office.electronic_office.doctype.workflow_instance.test_workflow_instance import TestWorkflowInstance
    from electronic_office.electronic_office.doctype.document_version.test_document_version import TestDocumentVersion
