...
function update_field_queries(frm) {
    ...
    frm.set_query('assignee_value', 'steps', function() {
        return {
            query: 'electronic_office.electronic_office.doctype.workflow_definition.workflow_definition.get_assignee_options',
            filters: {
    ...
    frm.set_query('field_name', 'conditions', function() {
        return {
            query: 'electronic_office.electronic_office.doctype.workflow_definition.workflow_definition.get_document_fields',
            filters: {
                document_type: frm.doc.document_type
            }
        };
...
function activate_workflow(frm) {
    frappe.call({
        method: 'electronic_office.electronic_office.doctype.workflow_definition.workflow_definition.activate_workflow',
        args: {
...
function deactivate_workflow(frm) {
    frappe.call({
        method: 'electronic_office.electronic_office.doctype.workflow_definition.workflow_definition.deactivate_workflow',
        args: {
            workflow_name: frm.doc.name
        },
        callback: function(r) {
...
function duplicate_workflow(frm) {
    frappe.call({
        method: 'electronic_office.electronic_office.doctype.workflow_definition.workflow_definition.duplicate_workflow',
        args: {
            workflow_name: frm.doc.name
        },
        callback: function(r) {
