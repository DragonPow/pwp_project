...
def after_install():
    ...
    This function sets up the basic configuration and default data for the Electronic Office System.
    """
    ...
    frappe.msgprint("Electronic Office System has been installed successfully!")

def create_default_roles():
    """Create default roles for the Electronic Office System"""
    roles = [
        {"role_name": "Document Manager", "desk_access": 1, "restrict_to_domain": "Electronic Office"},
        {"role_name": "Workflow Manager", "desk_access": 1, "restrict_to_domain": "Electronic Office"},
        {"role_name": "Document Approver", "desk_access": 1, "restrict_to_domain": "Electronic Office"},
        {"role_name": "Document Reviewer", "desk_access": 1, "restrict_to_domain": "Electronic Office"},
        {"role_name": "Digital Signature Authority", "desk_access": 1, "restrict_to_domain": "Electronic Office"}
    ]
...
def create_default_document_types():
    """Create default document types for the Electronic Office System"""
    document_types = [
...
def create_default_workflows():
    """Create default workflow definitions for the Electronic Office System"""
    workflows = [
        {
...
def setup_default_permissions():
    """Set up default permissions for the Electronic Office System"""
